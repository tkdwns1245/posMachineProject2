...
import kukirun.manager.SalesCalendarManager;
...
public class SalesCalendar {
	...
	public void CreateSaleCalender_Months(Sales_Status sales_status) { // 해당 년도의 1~12월 판넬 생성
	...
	int createDay=0;
	public void CreateSaleCalender_Days(Sales_Status sales_status,int month) { // 해당 월의 1~31일 달력 만듦
	...
	public void CreateDayDetail(Sales_Status sales_status, int day) { //달력에서 Day 판넬을 클릭 했을 때 Day의 상세 페이지 생성
	...
	int test=-1;
	public void CreateYearDetail(Sales_Status sales_status) { //해당 년도의 상세 페이지 생성
...
public void CreateMonthDetail(Sales_Status sales_status) { //해당 월의 상세 페이지 생성
